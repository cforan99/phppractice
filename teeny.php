...
<?php
	...
	if (isset($_POST['user_input'])&&!empty($_POST['user_input'])) {
		...
		$find = array(' thanks ', ' thank you ', ' please ', ' you ', ' for ', 'to', ' because ', ' of course ', 'be', ' by the way ', ' cool ', '.', ',', ' so', ' with ', ' later ', ' text ');
		$replace = array(' thnx ', ' thnx ', ' plz ', ' u ', ' 4 ', '2', ' bc ', ' ofc ', 'b', ' btw ', ' kewl ', '', '', ' sooooo ', ' w ', ' l8r ', ' txt ');
